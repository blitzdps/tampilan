                    ...
                    <div class="pt-3 form-group row">
                        ...
                        <?php if ($siswa['status']  == '1') : ?>
                            <div class="col-md-12 pt-3">
                                <a href="<?= base_url('tambah/data_siswa/admin?id=' . $siswa['id']) ?>"><button type="button" class="btn btn-block btn-primary"><i class="fa fa-check"></i> Tambah Data Siswa</button><a/>
                            </div>
                        <?php endif ?>
                    </div>
...
<div class="modal fade" id="konfirmasiModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                <a class="btn btn-success" href="<?= base_url('update/konfirmasi_ppdb/admin?id=' . $siswa['id']) ?>"><i class="fa fa-check"></i> Konfirmasi</a>
            </div>
        </div>
    </div>
</div>
