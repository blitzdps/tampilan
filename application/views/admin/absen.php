                    ...
                    <div style="width:100%; overflow-x:scroll">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $i = 1;
                                foreach ($absen as $d) : ?>
                                    <?php $san = $this->db->get_where('tbl_siswa', ['id_siswa' => $d['id_siswa']])->row_array(); ?>

                                    <tr>
                                        <th scope="row"><?= $i ?></th>
                                        <td><?= $san['nama_siswa'] ?></td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form target="_blank" action="<?= base_url('laporan/laporan_absen/') ?>" method="post">
                    <div class="modal-body">
                        <?php $kelas = $this->db->get_where('tbl_pelajaran', ['id_pelajaran' => $daftar_absen['id_pelajaran']])->row_array(); ?>
                        <div class="form-group">
                            <div class="card bg-secondary text-white shadow">
                                <div class="card-body">
                                    Absensi pelajaran : <?= $pelajaran['nama_pelajaran'] ?>
