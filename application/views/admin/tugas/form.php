...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <h1 class="h3 mb-4 text-gray-800"><i class="fa fa-user-plus fa-fw"></i> Tambah Tugas</h1>
            <hr />
        </div>
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="pt-2 fa fa-list-alt fa-fw"></i> Form Tambah Data Tugas
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('Admin_tugas/tambah') ?>" method="post">
                    ...
                    <small class="form-text text-danger"> <?php echo form_error('id_kelas');?> </small>
                       ...
                       <div class="col-md-6">
                            <div class="form-group">
                                    ...
                                    <input type="text" name="nama_tugas" id="nama_tugas" class="form-control" placeholder="Nama Tugas" required>
                                </div>
                       </div>
