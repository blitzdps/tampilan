...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-12 text-center">
            <h1 class="h3 mb-4 text-gray-800"><i class="fa fa-user-plus fa-fw"></i> Tambah Nilai Tugas</h1>
            <hr />
        </div>
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="pt-2 fa fa-list-alt fa-fw"></i> Form Tambah Data Nilai 
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('Admin_nilai_tugas/tambah') ?>" method="post">
                       ...
                       <div class="form-group">
                        ...
                        <select name="id_tugas" id="id_tugas" class="form-control" required>
                          <option value ="">--Pilih Tugas--</option>
                            ...
                            <option value="<?php echo $tgs->id_tugas?>"><?php echo $tgs->nama_tugas?></option>
                            <?php endforeach; ?>  
                        </select>
                        </div>
