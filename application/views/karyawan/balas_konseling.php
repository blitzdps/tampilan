        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="mt-2 font-weight-bold text-primary">Pengajuan : <?= date('d-m-Y', strtotime($konseling['tgl_pengajuan'])); ?>
                        <a href="<?= base_url('karyawan/konseling') ?>" class="p-2 badge badge-danger float-right"><i class="fa fa-angle-double-left"></i> Kembali</a>
                    </h6>
                </div>
                    ...
                    <div class="overflow-auto" id="scrollTop" style="max-height: 400px;">
                        <ul class="chat-list list-unstyled">
                            <?php foreach ($balas_konseling->result() as $a) : ?>
                                <?php $peng = $this->db->get_where('data_kelas', ['id' => $a->id_peng])->row_array(); ?>
                                ...
                                <?php elseif ($a->id_peng == $user['id']) : ?>
                                    ...
                                    <li class="clearfix chat-element right media">
                                        <div class="media-body">
                                            <div class="speech-box">
                                                <strong><b><?= $peng['nama'] ?></b> <span class="float-right badge badge-success">karyawan</span></strong>
                                                <p><?= $a->balasan ?></p>
                                                <small class="text-info"><?= $a->tgl ?>, <?= $a->waktu ?></small>
                                            </div>
                                        </div>
