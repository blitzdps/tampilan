        ...
        <div class="card-header">
            <h6 class="card-title"><i class="fas fa-newspaper"></i> Tambah Acara
                <div class="float-right">
                    <a href="<?= base_url('karyawan/acara') ?>" class="btn btn-block btn-sm btn-primary"><i class="fa fa-arrow-left"></i> Data Acara</a>
                </div>
            </h6>
        </div>

        <form method="post" action="<?= base_url('karyawan/tambah_acara') ?>" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <form action="<?= base_url('karyawan/tagline') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-footer">
                ...
                <a href="<?= base_url('karyawan/acara') ?>" class="btn btn-dark">Kembali</a>
            </div>
        </form>
        </form>
    </div>
...
<div class="modal fade" id="addKat" role="dialog" aria-labelledby="addKatLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('karyawan/kategori_acara/tambah') ?>" method="post">
