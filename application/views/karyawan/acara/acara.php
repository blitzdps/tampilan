                ...
                <div class="card-body">
                    <h1 class="h3 mb-4 text-gray-800"><i class="fas fa-list"></i> <?= $title ?>
                        <div class="float-right">
                            <a href="<?= base_url('karyawan/tambah_acara') ?>" class="btn btn-block btn-sm btn-info"><i class="fa fa-plus-circle"></i> Tambah Data</a>
                        </div>
                    </h1>
                                ...
                                foreach ($acara as $d) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td width="150">
                                            ...
                                            <a href="<?= base_url('karyawan/edit_acara?id=') ?><?= $d['id'] ?>" class="badge badge-success">Edit</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= base_url('hapus/hapus_acara/karyawan?id=') ?><?= $d['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                                                </div>
