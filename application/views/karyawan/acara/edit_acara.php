...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="float-right mr-1">
            <a href="<?= base_url('karyawan/acara') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fa fa fa-arrow-left"></i> Data Acara</a>
        </div>
    </div>
    <?php foreach ($acara as $a) : ?>
        ...
        <div class="card card-primary">
            ...
            <form method="post" action="<?= base_url('karyawan/edit_acara') ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="addKat" role="dialog" aria-labelledby="addKatLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('karyawan/kategori_acara/edit/' . $this->input->get('id')) ?>" method="post">
