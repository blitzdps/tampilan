        ...
        <div class="card-header">
            <h6 class="card-title"><i class="fas fa-newspaper"></i> Tambah Gallery
                <div class="float-right">
                    <a href="<?= base_url('karyawan/gallery') ?>" class="btn btn-block btn-sm btn-primary"><i class="fa fa-arrow-left"></i> Data Gallery</a>
                </div>
            </h6>
        </div>

        <?= form_open_multipart('karyawan/tambah_gallery'); ?>
        <div class="card-body">
...
<div class="modal fade" id="addKat" role="dialog" aria-labelledby="addKatLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('karyawan/kategori_gallery/tambah') ?>" method="post">
