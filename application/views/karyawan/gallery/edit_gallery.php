...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="float-right mr-1">
            <a href="<?= base_url('karyawan/gallery') ?>" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fa fa fa-arrow-left"></i> Data Gallery</a>
        </div>
    </div>
    <?php foreach ($gallery as $a) : ?>
        <div class="card card-primary">
            ...
            <form action="<?= base_url('karyawan/edit_gallery?id=' . $a['id']) ?>" method="post" enctype="multipart/form-data">
                <div class="card-body">
                ...
                <div class="card-footer">
                    ...
                    <a href="<?= base_url('karyawan/gallery') ?>" class="btn btn-dark">Kembali</a>
                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?= base_url('hapus/hapus_foto_gallery/karyawan/satu?id=') ?><?= $a['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
        ...
        <div class="modal fade" id="hapusGambar<?= $a['img2'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <a href="<?= base_url('hapus/hapus_foto_gallery/karyawan/dua?id=') ?><?= $a['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
        ...
        <div class="modal fade" id="hapusGambar<?= $a['img3'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <a href="<?= base_url('hapus/hapus_foto_gallery/karyawan/tiga?id=') ?><?= $a['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
...
<div class="modal fade" id="addKat" role="dialog" aria-labelledby="addKatLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('karyawan/kategori_gallery/edit/' . $this->input->get('id')) ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
