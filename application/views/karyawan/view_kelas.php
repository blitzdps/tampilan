<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="float-right mr-1">
            <a href="<?= base_url('karyawan/kelas') ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fa fa fa-arrow-left"></i> Data Kelas</a>
        </div>
    </div>
    <!-- Content Row -->
    <div class="row">
        ...
        <div class="modal fade" id="ubahsiswa<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url('update/update_isi_kursi/karyawan') ?>" method="post">
                        <div class="modal-body">
        ...
        <div class="modal fade" id="kosongData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form action="<?= base_url('update/update_isi_kursi_kosong/karyawan') ?>" method="post">
                            <input type="hidden" name="id" id="id" value="<?= $d['id'] ?>">
        ...
        <div class="modal fade" id="deleteData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <a href="<?= base_url('hapus/hapus_data_kursi/karyawan?id=') ?><?= $d['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
    ...
    <div class="modal fade" id="tambahKursi" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('karyawan/tambah_kursi?id=') ?><?= $this->uri->segment(3) ?>" method="post">
                    <div class="modal-body">
