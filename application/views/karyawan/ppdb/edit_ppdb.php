                ...
                <div class="modal fade" id="tolakModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <?= form_open_multipart('update/tolak_ppdb/karyawan'); ?>
                            <form action="<?= base_url('update/tolak_ppdb/karyawan') ?>" method="post">
                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-list-alt fa-fw"></i> <b>Form Data Diri</b>
                        <div class="float-right">
                            <a href="<?= base_url('karyawan/ppdb') ?>" class="btn btn-block btn-sm btn-primary"><i class="fa fa-angle-double-left"></i> Data PPDB</a>
                        </div>
                    </h6>
                </div>
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                          ...
                          <?php if ($siswa['status']  == '1') : ?>
                            <div class="col-md-12 pt-3">
                                <a href="<?= base_url('tambah/data_siswa/karyawan?id=' . $siswa['id']) ?>"><button type="button" class="btn btn-block btn-primary"><i class="fa fa-check"></i> Tambah Data Siswa</button><a/>
                            </div>
                        <?php endif ?>
                    </div>
...
<div class="modal fade" id="konfirmasiModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                <a class="btn btn-success" href="<?= base_url('update/konfirmasi_ppdb/karyawan?id=' . $siswa['id']) ?>"><i class="fa fa-check"></i> Konfirmasi</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="batalModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                <a class="btn btn-danger" href="<?= base_url('update/batal_konfirmasi_ppdb/karyawan?id=' . $siswa['id']) ?>"><i class="fa fa-ban"></i> Batal Konfirmasi</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="batalTolModal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                <a class="btn btn-danger" href="<?= base_url('update/batal_konfirmasi_ppdb/karyawan?id=' . $siswa['id']) ?>"><i class="fa fa-ban"></i> Batal Tolak</a>
            </div>
        </div>
    </div>
</div>
