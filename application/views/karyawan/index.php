...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <?php if ($user['role_id'] == '2') : ?>
            <a href="<?= base_url('karyawan/tambah_siswa'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah siswa</a>
        <?php endif ?>
    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <a href="<?= base_url('karyawan/daftar_absen') ?>">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <?php if ($user['role_id'] == '2') : ?>
                                    <a href="<?= base_url('karyawan/daftar_siswa') ?>">
                ...
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <?php if ($user['role_id'] == '2') : ?>
                                    <a href="<?= base_url('karyawan/kelas') ?>">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        <div class="card bg-primary text-white shadow">
                            <div class="card-body">
                                <a href="<?= base_url('karyawan/konseling') ?>" style="color:white">E-konseling <?php if ($notif_konseling) : ?><span class="badge badge-danger"><?= $notif_konseling ?></span><?php endif ?></a>
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card bg-success text-white shadow">
                            <div class="card-body">
                                <a href="<?= base_url('karyawan/perizinan') ?>" style="color:white">Perizinan <?php if ($notif_izin) : ?><span class="badge badge-danger"><?= $notif_izin ?></span><?php endif ?></a>
                                <div class="text-white-50 small">Total :
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="card bg-info text-white shadow">
                            <div class="card-body">
                                <a href="<?= base_url('karyawan/pelanggaran') ?>" style="color:white">Pelanggaran</a>
                                <div class="text-white-50 small">Total :
                    ...
                    <?php if ($user['role_id'] == '2') : ?>
                        <div class="col-lg-6 mb-4">
                            <div class="card bg-warning text-white shadow">
                                <div class="card-body">
                                    <a href="<?= base_url('karyawan/kontak') ?>" style="color:white">Kontak <?php if ($notif_kontak) : ?>
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <a href="<?= base_url('karyawan/acara') ?>">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <a href="<?= base_url('karyawan/gallery') ?>">
...
<div class="modal fade" id="Absen" role="dialog" aria-labelledby="AbsenLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('karyawan/daftar_absen') ?>" method="post">
