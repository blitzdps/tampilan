                                ...
                                foreach ($absen as $d) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php if ($d['status'] == 'Selesai') : ?>
                                                ...
                                                <a href="<?= base_url('karyawan/absen/') ?><?= $d['tgl'] ?>?id=<?= $d['id'] ?>" class="badge badge-success"><i class="fa fa-eye"></i> View</a>
                                            <?php endif ?>
                                            <?php if ($d['status'] == 'Belum Selesai') : ?>
                                                <a href="<?= base_url('karyawan/absen/') ?><?= $d['tgl'] ?>?id=<?= $d['id'] ?>" class="badge badge-primary">Absen</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= base_url('update/tutup_absen_kelas/karyawan/daftar_absen?id=') ?><?= $d['id'] ?>" class="btn btn-warning">Tutup Absen</a>
                                                </div>
                                    ...
                                    <div class="modal fade" id="deleteData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                    <a href="<?= base_url('hapus/hapus_daftar_absen/karyawan?id=') ?><?= $d['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                                                </div>
