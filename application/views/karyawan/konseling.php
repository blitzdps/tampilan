                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($d['status']  !== 'Selesai') : ?>
                                                <a href="<?= base_url('karyawan/balas_konseling?id=') ?><?= $d['id'] ?>" class="badge badge-success">Balas</a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<?= base_url('update/tutup_konseling/karyawan') ?>" method="post">
                            <input type="hidden" name="id" value="<?= $d['id'] ?>">
                            <input type="hidden" name="siswa" value="<?= $san['nama'] ?>">
                            <input type="hidden" name="topik" value="<?= $d['topik'] ?>">
                            <input type="hidden" name="penutup" value="karyawan">
        ...
        <div class="modal fade" id="deleteData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                        <a href="<?= base_url('hapus/hapus_konseling/karyawan?id=') ?><?= $d['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                    </div>
    ...
    <div class="modal fade" id="addNewData" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('karyawan/konseling') ?>" method="post">
                    <div class="modal-body">
