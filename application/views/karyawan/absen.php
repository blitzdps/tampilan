            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <h4 class="mb-5 header-title">
                        <a href="<?= base_url('karyawan/daftar_absen') ?>" class="btn btn-sm btn-danger mb-3"><i class="fa fa-angle-double-left"></i> Kembali</a>
                                    ...
                                    <div class="modal fade" id="updateData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('update/update_status_absen/karyawan') ?>" method="post">
                                    ...
                                    <div class="modal fade" id="deleteData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                    <a href="<?= base_url('hapus/hapus_absen_siswa/karyawan/' . $tgl_absen . '') ?>?id=<?= $d['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                                                </div>
    ...
    <div class="modal fade" id="tutupData" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    <a href="<?= base_url('update/tutup_absen_kelas/karyawan?id=') ?><?= $daftar_absen['id'] ?>" class="btn btn-warning">Tutup Absen</a>
                </div>
