                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="pt-2 fa fa-list-alt fa-fw"></i> Form Pendaftaran
                        ...
                        <div class="float-right">
                            <a href="<?= base_url('karyawan/daftar_siswa') ?>" class="btn btn-block btn-primary btn-sm"><i class="fa fa-angle-double-left"></i> Data siswa</a>
                        </div>
                    </h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?= base_url('karyawan/tambah_siswa') ?>" method="post">
