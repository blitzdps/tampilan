                            ...
                            <tbody>
                                ...
                                foreach ($kelas as $d) : ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $sum_siswa ?></td>
                                        <td>
                                            <a href="<?= base_url('karyawan/view_kelas/') ?><?= $d['id'] ?>" class="badge badge-primary">View</a>
                                    ...
                                    <div class="modal fade" id="updateData<?= $d['id'] ?>" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('update/update_kelas/karyawan') ?>" method="post">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a href="<?= base_url('hapus/hapus_kelas/karyawan?id=') ?><?= $d['id'] ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                                                </div>
...
<div class="modal fade" id="addNewData" role="dialog" aria-labelledby="addNewDataLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('karyawan/kelas') ?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
