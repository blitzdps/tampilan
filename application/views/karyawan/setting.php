        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('karyawan/setting') ?>" method="post">
                        ...
                        <div class="form-group">
                            <label>Alamat</label>
                            <textarea type="text" class="form-control" name="alamat" onfocus=this.value=''><?= $user['alamat']; ?></textarea>
                        </div>

                        <div class="form-group">
                            <label>Nomor Hp</label>
                            <input type="number" class="form-control" name="no_hp" value="<?= $user['telp']; ?>" onfocus=this.value=''>
                        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('karyawan/edit_pass') ?>" method="post">
                        <input type="hidden" name="id" value="<?= $user['id']; ?>">
                        <div class="form-group">
