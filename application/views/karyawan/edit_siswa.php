                ...
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="pt-2 fa fa-list-alt fa-fw"></i> Form edit data siswa
                        ...
                        <div class="float-right">
                            <a href="<?= base_url('karyawan/daftar_siswa') ?>" class="btn btn-block btn-danger btn-sm"><i class="fa fa-angle-double-left"></i> Kembali</a>
                        </div>
                    </h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?= base_url('karyawan/update_siswa?id=') ?><?= $siswa['id'] ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?= form_error('thn_mauk', '<small class="text-danger pl-3">', ' </small>') ?>
                                </div>
                        ...
                        <div class="pt-3 form-group row">
                            <div class="col-md-12">
                                <button type="submit" class="btn-block btn btn-primary">Simpan Data siswa</button>
                            </div>
                        </div>
